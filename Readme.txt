...
The repository contains two types of branches: tutorials and challenges
	...
	Tutorials: These contain code written during/ after going through a tutorial on a specific aspect of lib-gdx.
	Challenges: These contain the code for challenges that I set for myself to apply the work that I learn in the tutorial .